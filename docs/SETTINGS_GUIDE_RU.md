...
В магазине **Hikki** предусмотрена функция добавления пакетов вручную для проверки добавленных настроек в приложении.

Путь в приложении: **Настройки -> Установленные -> Пакеты магазина вручную**.

> [!IMPORTANT]
> Для получения доступа к этой функции необходимо обратиться в [чат](https://t.me/hikkichats) для получения статуса
> разработчика.
